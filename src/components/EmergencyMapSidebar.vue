  ...
  >
    ...
    >
      <div class="d-flex justify-content-between align-items-center mb-1">
        <h3 class="fw-bold mb-0 text-slate-800 map-style-30">
          <i class="bi bi-broadcast me-1 map-style-6"></i> Radar Donor Scan
        </h3>
        <span class="badge text-white map-style-31">{{
      ...
      <div
        class="d-flex justify-content-between align-items-center py-1 map-style-33"
      >
    ...
    >
      ...
      <p class="small text-slate-500 mb-0 map-style-35">
        Radar active across 10 km radius. Responders will appear here live when they accept
        emergency requests and share location.
      </p>
    </div>
      ...
      >
        <div class="d-flex justify-content-between align-items-center mb-1">
          <div>
            ...
            <span
              class="badge ms-1 text-white map-style-31"
              >{{ resp.bloodType }}</span
            >
          </div>
          <span
        ...
        <div class="small text-slate-600 mb-1 map-style-35">
          <i class="bi bi-hospital me-1 map-style-6"></i> {{ resp.hospitalName }}
        </div>
    ...
    <div class="mt-3 pt-3 border-top border-slate-200">
      <div class="small font-weight-700 text-slate-700 mb-2 map-style-33">
        <i class="bi bi-broadcast me-1 map-style-6"></i> RECENT ACTIVITY LOG
      </div>
