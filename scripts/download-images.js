...
const imagesToDownload = [
  {
    ...
    directUrl:
      'https://suckhoedoisong.qltns.mediacdn.vn/zoom/600_315/Images/ngocanh/2021/05/25/co-the-hien-mau-sau-khi-tiem-vac-xin-covid-19-khong1621917290.jpg'
  },
  {
  ...
  },
  {
    ...
    directUrl:
      'https://benhandientu.moh.gov.vn/storage/uploads/2025/09/benh-vien-truyen-mau-huyet-hoc-1-160fbe14e2-1758640359.png'
  },
  {
    // Blood bag close-up (blood donation scene)
    name: 'hero-blood-donation.jpg',
    directUrl:
      'https://suckhoedoisong.qltns.mediacdn.vn/324455921873985536/2025/5/6/z6553302146898181e1f70d3ff95078b8489446861653c-17465692224901846078957.jpg'
  }
]

const headers = {
  'User-Agent':
    'LifeLinkVolunteerCoordinationVietnam/1.0 (https://lifelink.vn; contact@lifelink.vn) Node.js'
}
