          ...
          <tbody>
            <tr v-for="(u, index) in allSystemUsers.slice(0, userDisplayLimit)" :key="u.id">
              ...
              <td class="dashboard-style-22">
                <span class="ll-badge-blood d-inline-flex align-items-center justify-content-center" style="height: 32px !important; padding-left: 12px; padding-right: 12px; border-radius: var(--ll-radius-sm) !important;">{{ u.bloodType || 'N/A' }}</span>
              </td>
              <td class="dashboard-style-22">
                <span
                  :class="
              ...
              <td class="dashboard-style-22">
                <select
                  ...
                  style="height: 32px !important; min-height: 32px !important; min-width: 100px; padding-top: 0 !important; padding-bottom: 0 !important; line-height: 1.2 !important; border-radius: var(--ll-radius-sm) !important;"
                  :value="u.role || 'donor'"
              ...
              <td class="dashboard-style-25 pe-4">
                <div class="d-flex justify-content-end align-items-center gap-2 dashboard-style-26">
                  ...
                  <button
                    ...
                    style="height: 32px !important; width: 32px !important; border-radius: var(--ll-radius-sm) !important;"
                    type="button"
                    title="Delete user"
                    :disabled="u.uid === userProfile.uid"
